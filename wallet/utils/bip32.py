...
class Wallet(object):
    ...
    **WARNING**:
    ...
    @classmethod
    def from_master_secret_slow(cls, password, network=JorisRobinMainNet):
        """
    ...
    def get_network(self, network):
        ...
        return JorisRobinMainNet
        
    @classmethod
    def new_random_wallet(cls, user_entropy=None, network=JorisRobinMainNet):
        """
