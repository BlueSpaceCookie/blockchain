...
from ..network import JorisRobinMainNet
...
class PrivateKey(Key):
    def __init__(self, secret_exponent, network=JorisRobinMainNet,
                 *args, **kwargs):
    ...
    @classmethod
    def from_wif(cls, wif, network=JorisRobinMainNet):
    ...
    @classmethod
    def from_hex_key(cls, key, network=JorisRobinMainNet):
        if len(key) == 32:
    ...
    @classmethod
    def from_master_password(cls, password, network=JorisRobinMainNet):
...
class PublicKey(Key):
    def __init__(self, verifying_key, network=JorisRobinMainNet, *args, **kwargs):
        """Create a public key.
    ...
    @classmethod
    def from_point(cls, point, network=JorisRobinMainNet, **kwargs):
    ...
    def from_verifying_key(
            cls, verifying_key, network=JorisRobinMainNet, **kwargs):
    ...
    @classmethod
    def from_public_pair(cls, pair, network=JorisRobinMainNet, **kwargs):
